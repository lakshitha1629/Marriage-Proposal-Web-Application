                    ...
                    <div>
                        <section class="page-section" style="height: 100px;width: 280px;height: 245px;
                            ...
                            <div class="chat-header" style="background-color: #005cbf;color: #fff">
                                Instant Chatti
                                <img src="icons8-cancel-50.png" style="width: 30px;height: 30px;margin: -3px 152px;
                            ...
                            <div class="container" style="border: 3px solid red;width: 100%">
                                ...
                                <div class="row" style="background: #fff;">
                                    <div class="col-12">
                                        <input type="text" id="inputlist" class="form-control" placeholder="Enter Member name" style="width: 127%" />
                                    </div>
                                </div>
                                ...
                                <div class="row" style="background: #fff;">
                                    <div class="col-9">
                                        <div id="text" style='overflow:auto; width:250px;height:160px;border: 1px solid;background-color: lightgray;'>
                                ...
                                <div class="row" style="background: #fff;">
                                    <div class="col-10">
                                        <input type="text" value="" placeholder="Your Message" id="msg" class="form-control" maxlength="50">
                                        <div  style="margin: -38px 100% 1px;cursor: pointer">

                                            <div id="btnSend">
                                                <img src="icons8-paper-plane-480.png" style="width: 40px;height: 40px">
                                            </div>
                                        </div>
                                    </div>
                                </div>
